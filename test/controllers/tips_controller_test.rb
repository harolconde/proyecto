...
class TipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tip" do
    assert_difference('Tip.count') do
      post tips_url, params: { tip: { description: @tip.description, name: @tip.name } }, as: :json
    end
  ...
  test "should update tip" do
    patch tip_url(@tip), params: { tip: { description: @tip.description, name: @tip.name } }, as: :json
    assert_response 200
  end
