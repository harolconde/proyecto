...
class SponsorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post sponsors_url, params: { sponsor: { img: @sponsor.img, name: @sponsor.name } }, as: :json
    end
  ...
  test "should update sponsor" do
    patch sponsor_url(@sponsor), params: { sponsor: { img: @sponsor.img, name: @sponsor.name } }, as: :json
    assert_response 200
  end
